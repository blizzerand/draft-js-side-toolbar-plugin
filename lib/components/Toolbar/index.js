...
var Toolbar = function (_React$Component) {
  ...
  function Toolbar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (!selection.getHasFocus() && _this.props.fieldHasFocus !== "visible") {
        _this.setState({
          position: {
            transform: "scale(0)"
          }
  ...
  _createClass(Toolbar, [{
    ...
    value: function render() {
      var _props = this.props,
          store = _props.store,
          customTheme = _props.customTheme;
      var theme = this.props.theme;

      theme.blockTypeSelectStyles ? theme.blockTypeSelectStyles = _extends({}, theme.blockTypeSelectStyles, customTheme.blockTypeSelectStyles) : null;
      theme.buttonStyles ? theme.buttonStyles = _extends({}, theme.buttonStyles, customTheme.buttonStyles) : null;
      theme.toolbarStyles ? theme.toolbarStyles = _extends({}, theme.toolbarStyles, customTheme.toolbarStyles) : null;

      return _react2.default.createElement(
        "div",
        { className: theme.toolbarStyles.wrapper, style: this.state.position },
